...
sourcePath: "https://mtf.wiki/zh-cn/docs/medicine/risk/"
...
editNotes:
  - "スピロノラクトンの併用注意で「血中ナトリウムを上昇させる薬剤」とあった誤りを、正しくは「血中カリウムを上昇させる薬剤」（高カリウム血症の注意）に修正しました。"
  - "簡体字や文字化け（&le; などのHTML実体参照）を、日本語の表記に直しました。"
  - "冒頭に医師への相談をうながす注意書きと、末尾に出典・ライセンスの記載を加えました。"
---
> **大切なこと**　日本では、ホルモン療法は医師のもとで受けられます。この記事は、からだの仕組みや副作用・リスクを知るための情報で、自己判断での使用や量の調整をすすめるものではありません。実際の治療やお薬のことは、かならず医師に相談してください。

GAHT（HRT）を受けるあいだは、エストロゲン剤・抗アンドロゲン剤の種類や量について医師とよく相談し、効果とリスクのバランスをみながら進めます。お薬を使って体調が悪くなったときは、がまんせずに、すぐに医師の診察を受けてください。
...
本剤は日本で承認されていない。下記はニュージーランドで販売された「シテロン®」の[添付文書](https://www.medsafe.govt.nz/profs/datasheet/s/Siteronetab.pdf)に表示された副作用：
...
| プロゲスチン系薬物：<br>メドロキシプロゲステロン、及び酢酸シプロテロンなど | CYP3A4で代謝される[^6] [^7] [^20]。 |
...
| GnRH 類似体、<br>及びプロゲスチン系薬物 | GnRH 類似体の添付文書により、プロゲスチン系薬物は高プロラクチン血症を誘発し、GnRH 受容体を減少させるので、その併用は避けることが望まれます[^23]。<br>ただし、臨床試験の結果、高プロラクチン血症と脳下垂体腺腫を有する患者において、GnRH への反応は上昇するとの報告がある[^32]。<br>GnRH 類似体を投与した場合、その他の抗アンドロゲン剤は必要ではない。 |
...
| スピロノラクトン、<br>及びその他の薬剤 | CYP3A4、又はCYP2C11で代謝される薬剤に影響を与えると考えられる[^21] [^31]。 |
| ビカルタミド、<br>及びその他の薬剤 | CYP3A4で代謝される薬剤に影響を与える恐れがある[^10] [^22]。<br>抗凝固剤の効果に影響を与える恐れがある。 |
