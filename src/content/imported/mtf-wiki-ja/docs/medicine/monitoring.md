...
sourcePath: "https://mtf.wiki/zh-cn/docs/medicine/monitoring/"
...
editNotes:
  - "プロラクチン（PRL）の基準範囲が「FSHの基準範囲」と誤記されていた箇所を修正しました。"
  - "翻訳で主語が抜けていた箇所（急性膵炎・乳癌・髄膜腫の記述）を補いました。"
  - "冒頭に医師への相談をうながす注意書きと、出典・ライセンスの記載を加えました。"
---
> **大切なこと**　この記事は、検査やモニタリングのしくみを知るための医療リテラシーの解説で、自己判断での検査・服薬の手引きではありません。検査やホルモン治療の判断、結果の読み取りは、かならず医師に相談してください。
...
- **絶食血中測定、特には低密度リポ蛋白（LDL）・トリグリセリドの測定。** 高脂血症により、心血管系症状が現れることがある。  
  ...
  - 高トリグリセリド血症により、急性膵炎が発生したとの報告がある[^8] [^18] [^19] [^24]。その既往歴がある者は、エストロゲンを慎重に使用し、観察を十分に行うこと。
...
- **Ｘ線撮影による乳房検診。** エストロゲン・プロゲスチン製剤は乳癌になる危険性を高めるとの報告がある [^8] [^9] [^14]。長期的に投与した場合、格別に注意すること。
- **磁気共鳴映像法（MRI）による脳の検診。** 酢酸シプロテロンの長期・過量投与により、髄膜腫が発生したとの報告がある。髄膜腫が認められた場合、投与を直ちに中止すること [^10] [^16]。
- **体重・体脂肪の測定。** 低下しているテストステロン濃度は、脂肪組織、特には皮下脂肪を増加させる。一方、エストロゲンは脂肪細胞の分化・成熟を促進し、皮下脂肪の分解を抑制する[^25]。その結果、GAHT を受ける MtF においては体重・体脂肪の増加がよく見られるとの報告がある[^26]。健康のため、定期的に体重を測定し、適切な運動を行い、過重を避けること。
...
エストラジオールを含むジェル剤を腕部に擦り付けた場合、その部位から採った血液はエストラジオール濃度が高く出て、検査結果が参考にならないので、このようにしないでください。  
...
スピロノラクトン・ビカルタミドを投与し、エストロゲンと併用しない場合、テストステロン濃度は十分に下がらないことがあるので、下記の範囲を参考にしないこと。
酢酸シプロテロンなどを投与する場合は、テストステロン濃度が下がるため、女性に対する基準範囲以内を維持すること。  
...
また、ストレスや運動、乳房への刺激などが PRL を増加させる可能性がある[^28] [^29]。

- **成年女性**に対する プロラクチン（PRL）の基準範囲：4.79 – 23.3 ng/mL。 [^1]
