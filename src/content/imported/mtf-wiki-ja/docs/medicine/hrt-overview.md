...
sourcePath: "https://mtf.wiki/zh-cn/docs/medicine/hrt/overview/"
sourceLicense: "CC BY-SA 4.0（原文を日本語に抄訳・再構成したもの）"
sourceCategory: "医療情報"
importedAt: 2026-05-31
reviewStatus: needs-review
ownPage: /hrt-medications/
editNotes:
  - "原文では「身体的治療は特例法に基づきホルモン療法を行う」とありましたが、特例法は戸籍上の性別変更のための法律で、ホルモン療法の根拠ではありません。診療ガイドラインにもとづく医療として書き直しました。"
  - "GnRHアンタゴニスト（拮抗薬）である「レルミナ」を、GnRHアゴニストの例として挙げていた誤りを修正し、アゴニストとアンタゴニストを分けて記載しました。"
  - "戸籍の性別変更に関する2024年の高裁判断を「長崎高裁」としていた誤りを「広島高裁」に直しました。"
  - "「ホルモン治療が特例法の要件」という誤った記述を削除し、要件ではないことを明記しました。"
  - "成年女性のテストステロン基準範囲の下限を、出典に合わせて 0.05→0.1 ng/mL に修正しました。"
  - "古いガイドライン（第4版改・2018）の引用を、最新の第5版「性別不合に関する診断と治療のガイドライン」（2024）に更新しました。"
  - "自己投薬の入手先・販売サイト（HRT.Cafe／HRT.coffee／DIY HRT Dictionary などの薬剤関連リンク）を削除しました。"
  - "取り込み時の不具合（「建設中」の表示、誤字、HTMLタグの残り、直接的すぎる表現）を整え、冒頭に医師への相談をうながす注意書きを加えました。"
---
> **大切なこと**　日本では、ホルモン療法や手術は医師のもとで受けられます。この記事は、からだの仕組みや選択肢を知るための情報で、自己判断での使用・調整をすすめるものではありません。実際の治療・お薬・手術は、かならず医師に相談してください。


**性別適合ホルモン療法（GAHT）**、又は**トランスジェンダーホルモン療法（HRT）** とは、性別不合（Gender Incongruence）を抱える人の身体的性別とは反対の性ホルモンを投与することで、身体的特徴を本来の性（性の自己意識）に近づける治療[^1] [^4]。ホルモン療法は必要ではないが、自己意識に一致する性別での社会生活を容易にするとともに、身体の性の不一致による苦悩を軽減する効果が認められている。

臨床試験において、医師の指導によるGAHTの安全性は認められている[^2]。国際連合機関・[人権高等弁務官事務所](https://www.ohchr.org)（OHCHR）の提案した「[UN Free & Equal](https://www.unfe.org)」（国連自由・平等行動企画）及び「[The Yogyakarta Principles](https://yogyakartaprinciples.org)」（[ジョグジャカルタ原則](https://ja.wikipedia.org/wiki/%E3%82%B8%E3%83%A7%E3%82%B0%E3%82%B8%E3%83%A3%E3%82%AB%E3%83%AB%E3%82%BF%E5%8E%9F%E5%89%87)）において、性別適合の医学的対処、及び当事者の人権の保障が推奨されている。

日本では、ホルモン療法などの身体的治療は、日本精神神経学会の「性同一性障害に関する診断と治療のガイドライン」などにもとづいて、医師のもとで行われます。（「性同一性障害者の性別の取扱いの特例に関する法律」は、戸籍上の性別を変えるための法律で、ホルモン療法の根拠となる法律ではありません。）
...
**エストロゲン**（Estrogen）は、**エストロン**（Estrone/E1）、**エストラジオール**（Estradiol/E2）、**エストリオール**（Estriol/E3）の3種類からなり、ステロイドホルモンの一種。一般に卵胞ホルモン、女性ホルモンと呼ばれる。その中でも、エストラジオールは、女性の卵巣から分泌され、最も強い生理活性を持つ卵胞ホルモンの代表的なものであり、MtF に対する GAHT には主に投与される薬剤である[^5]。
...
- 吉草酸エストラジオール錠は分子量が大きいぶん、同じ mg 数でも、エストラジオール錠とくらべて血中エストラジオール濃度が約 25% 低く出ます。そのため、できるだけエストラジオール錠を使うことがすすめられます[^7]。
...
- 下記は血中テストステロンを減少させる薬：
  ...
  - **GnRH アゴニスト** ＜GnRHa／GnRH類似体＞【スプレキュア点鼻液（ブセレリン）、リュープリン（リュープロレリン）など。思春期ブロック療法にも用いられる[^20]】
  - **GnRH 拮抗薬（アンタゴニスト）**【レルミナ錠（レルゴリクス）など。国内の適応は子宮筋腫・子宮内膜症で、アゴニストと異なり、初期のフレアアップ（一過性のホルモン上昇）を起こさず、すぐに GnRH 受容体を遮断する】
  - 大量投与されるエストロゲン
...
- 血中テストステロン濃度は、成年女性としてホルモン濃度の生理的基準の範囲（0.1–0.55 ng/mL）に維持すること[^5] [^6]。基準値未満になることは必要ではない。
...
- アンドロゲン受容体阻害系薬物を投与した場合、その効果は、血中ホルモン検査結果を示唆しない[^5] [^21]。エストロゲンと併用した時、エストロゲンだけが血中テストステロン濃度を低下させることがあり、検査結果によってその薬剤の必要量を間接的に判断できる。
...
筋肉量の減少,3 − 6ヶ月,1 − 2 年
皮脂の分泌量が低下し、皮膚がきめ細やかになる,3 − 6ヶ月,不明
体毛が減少し、柔らかくなる,6 - 12ヶ月,3 年以上
頭髪が増えることがある,1 − 3ヶ月,1 − 2 年
勃起不全,1 − 3ヶ月,3 − 6ヶ月
精巣の萎縮,3 − 6ヶ月,2 − 3 年
性機能障害,異なる,異なる
造精機能喪失,異なる,異なる
...
- 「[性同一性障害者の性別の取扱いの特例に関する法律](https://ja.wikipedia.org/wiki/%E6%80%A7%E5%90%8C%E4%B8%80%E6%80%A7%E9%9A%9C%E5%AE%B3%E8%80%85%E3%81%AE%E6%80%A7%E5%88%A5%E3%81%AE%E5%8F%96%E6%89%B1%E3%81%84%E3%81%AE%E7%89%B9%E4%BE%8B%E3%81%AB%E9%96%A2%E3%81%99%E3%82%8B%E6%B3%95%E5%BE%8B)」（性同一性障害特例法）：2003年7月10日に成立し、2004年7月16日に施行された日本の法律。
  - 性別変更の要件である生殖機能をなくす手術（生殖不能要件）については、最高裁判所大法廷が 2023 年１０月に違憲判断を示しました。その後、広島高等裁判所は 2024 年７月に、もう一つの「外観」に関する要件についても「**憲法違反の疑いがあると言わざるをえない**」とし、手術を受けていないトランス女性（MtF）の性別変更を認めました[^99]。
    ホルモン治療を受けていること自体は、特例法の要件ではありません。
- 「[性別不合に関する診断と治療のガイドライン（第5版）](https://www.jspn.or.jp/uploads/uploads/files/activity/gid_guideline_no5_20241016.pdf)」：日本精神神経学会・日本GI（性別不合）学会、2024年8月（2024年10月一部補正）。第5版で名称が「性同一性障害」から「性別不合」へ改められました。旧版は「[性同一性障害に関する診断と治療のガイドライン第4版改](https://www.jspn.or.jp/uploads/uploads/files/activity/gid_guideline_no4_20180120.pdf)」（2018年1月20日改訂）。
...
この記事は、MtF.wiki の記事をもとに、日本の状況にあわせて抄訳・再構成したものです（原文: <https://mtf.wiki/> ）。原文は CC BY-SA 4.0 ライセンスのもとで公開されており、この日本語版（抄訳・再構成）も同じく CC BY-SA 4.0 ライセンスのもとで公開します。
